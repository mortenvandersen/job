---
company: Axogen
role: VP, Planning and Business Development
status: assessed
...
## Fit Assessment: VP, Planning and Business Development — Axogen

**Deal-breakers**: None. Role is remote, comp is far above floor, no sales quota, company is publicly traded with hundreds of employees.

| Dimension | Score | Notes |
|---|---|---|
| A. Role Type | 5/5 | Corp Strategy + Corp Dev hybrid. Reports to CEO, member of Executive Team. Scope includes enterprise strategic planning, M&A origination and execution, new market entry — exactly the target functional area. "Business Development" here is inorganic growth, not sales. |
| B. Industry | 3/5 | Medical devices / peripheral nerve repair. Tier 3. Healthcare but not healthcare education. No EdTech angle. Skills transfer fine but no existing domain knowledge. |
| C. Company Stage | 3/5 | Public company (~$180M revenue), commercially established in a niche medical market. Stable and growing, but not a high-growth startup. Not declining — positive revenue growth and active R&D pipeline. |
...
**Gaps & flags:**
- 🔴 "Minimum 10 years of experience in senior leadership roles within a medical device or biotech company" — Hard barrier. Zero medical device background means ATS screening will likely filter this. Referral or direct outreach is near-mandatory.
- 🔴 "Minimum of BS in Life Sciences or Engineering" — Listed as a floor, not a preference. Business background is not Life Sciences. Second ATS flag.
- 🟡 Advanced degree (MD/PhD/PharmD/DSci) preferred — Not a hard requirement, but signals the company skews clinical/scientific in leadership. Morten's exec credentials are commercial.
- 🟡 50% travel requirement — Significant. Yellow flag per preferences. Worth raising early in process.

**Strongest angles — what to emphasize if applying:**
- Currently leading the Labster divestiture — live M&A sell-side process experience directly analogous to what this role demands
- LEGO Ventures: 5 early-stage investments end-to-end — buy-side evaluation, diligence, and board-level decisions
- Led $100M Series C & C+ for Labster — transaction structuring, buy-side relationships
- VP/GM with CEO-level relationships and direct experience running a P&L — not just a strategy advisor
- UbiSim/Labster bridges EdTech and healthcare: the closest domain analogue available
